...
const ReportTemplate = ({ data, isGeneratingInsights }: { data: ReportData, isGeneratingInsights: boolean }) => {
    ...
    return (
        <div id="report-content-for-pdf" className="space-y-4">
            {/* Page 1 */}
            <div className="bg-white text-gray-800 font-sans p-8 shadow-2xl report-page" style={{ width: '210mm', height: '297mm' }}>
                <div style={{ height: 'calc(100% - 30px)' }}> {/* Main content area */}
                ...
                <footer className="text-center text-xs text-gray-400 pt-4 border-t" style={{ height: '30px' }}>
