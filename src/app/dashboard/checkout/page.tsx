...
export default function CheckoutPage() {
    ...
    const qrCodeUrl = `https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=upi://pay?pa=alex.varghese@superyes&pn=Taxxmo&am=${amountString}&cu=INR&tn=Taxxmo%20Purchase`;
