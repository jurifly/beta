...
import { Loader2, Send, MessageCircle, Bug, Lightbulb, Palette, ThumbsUp, ThumbsDown } from "lucide-react";
...
export default function FeedbackPage() {
  ...
  const { control, handleSubmit, formState: { errors, isSubmitting }, reset, watch } = useForm<FeedbackFormData>({
