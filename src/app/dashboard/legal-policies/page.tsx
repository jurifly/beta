...
const policies = {
    "terms": {
        ...
        content: `
            <p>Welcome to LexIQ. These terms and conditions outline the rules and regulations for the use of our website and services.</p>
            <h3 class="font-semibold mt-4 mb-2">1. Acceptance of Terms</h3>
            <p>By accessing this platform, you accept these terms and conditions. Do not continue to use LexIQ if you do not agree to all of the terms and conditions stated on this page.</p>
            ...
            <p>The Service and its original content, features, and functionality are and will remain the exclusive property of LexIQ and its licensors. Our trademarks may not be used in connection with any product or service without the prior written consent of LexIQ.</p>
            <h3 class="font-semibold mt-4 mb-2">4. Limitation of Liability</h3>
            <p>In no event shall LexIQ, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
    ...
    "privacy": {
        ...
        lastUpdated: "October 26, 2023",
        content: `
            <p>Your privacy is important to us. It is LexIQ's policy to respect your privacy regarding any information we may collect from you across our website.</p>
    ...
    "disclaimer": {
        ...
        lastUpdated: "October 26, 2023",
        content: `
            <p>The features and information generated by the Artificial Intelligence (AI) on the LexIQ platform are provided for informational purposes only.</p>
            ...
            <p>LexIQ disclaims all liability for any errors or omissions in the content provided by the AI and for any actions taken in reliance on that content.</p>
        `
    }
};
