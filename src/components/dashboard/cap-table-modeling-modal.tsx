          ...
          <div className="space-y-6 py-4">
              {!isPaidUser ? (
                <div className="flex h-full min-h-[500px] items-center justify-center">
                    <UpgradePrompt icon={<Lock className="h-12 w-12 text-primary" />} title="Unlock Round Modeling" description="This is a premium feature. Upgrade your plan to model fundraising rounds and see their impact on your cap table." />
                </div>
              ) : (
                <>
