...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert AI Legal and Compliance Analyst. Your task is to comprehensively analyze the provided document and return a structured analysis.
...
3.  **Identify Risk Flags**: Scrutinize the document for any potential risks, liabilities, or unfavorable terms.
    *   For a 'Legal Contract', look for penalty clauses, ambiguous terms, unfavorable jurisdiction, long lock-in periods, etc.
    *   For a 'Government Notice', identify the core issue, potential legal implications, and any mentioned deadlines.
