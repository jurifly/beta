...
3.  **Strict Date Calculations**: You MUST calculate precise due dates in "YYYY-MM-DD" format based on these rules:
    ...
    *   **Quarterly**: For tasks that occur quarterly (e.g., on the 15th of April, July, October, January), generate entries for **all four** due dates for the financial year related to the \`currentDate\`. For example, if \`currentDate\` is May 1st, 2024, you should generate entries for the due dates in July 2024, October 2024, January 2025, and April 2025.
